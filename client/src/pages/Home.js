            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <p className="text-lg mb-6 text-gray-600 leading-relaxed">
                  Welcome to Barber, where tradition meets modern style. Our
                  skilled barbers have been providing top-notch haircuts and
                  grooming services since 1950. We take pride in our craft and
                  ensure that every client leaves our shop looking and feeling
                  their best.
                </p>
                ...
                {[
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Experience our professional {service.toLowerCase()}{" "}
                      service.
                    </p>
                  </div>
                ))}
